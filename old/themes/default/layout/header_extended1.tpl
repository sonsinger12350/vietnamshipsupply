    ...
    <div class="body-bg">
<div class="bg_dau">
	<div class="header_dau">
		<div class="wraper">
			<div class="phandau">
				
				<div class="col-xs-24 col-sm-8 col-md-8 logone">
			<div class="container">
				...
				<div class="col-xs-24 col-sm-8 col-md-8 email_dau">[CONTACT]</div>
				<div class="col-xs-24 col-sm-8 col-md-8 headerSearch">
                                <div class="input-group">
                                    <input type="text" class="form-control" maxlength="{NV_MAX_SEARCH_LENGTH}" placeholder="{LANG.search}...">
                                    <span class="input-group-btn"><button type="button" class="butonseach" data-url="{THEME_SEARCH_URL}" data-minlength="{NV_MIN_SEARCH_LENGTH}" data-click="y"><em class="fa fa-search fa-lg"></em></button></span>
                                </div>
				</div>
			</div>
		</div>
