...
<script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/jspa/plugins-ck.js"></script>
		<script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/jspa/mainplugins-ck.js"></script>
...
<div id="responsive-ribbon"></div>
  <!-- BEGIN: loop -->
	<li>
		 <a href="{ROW.link}" title="{ROW.title}"><img  src="{ROW.thumb}" />
