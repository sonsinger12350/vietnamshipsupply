	...
	<div class="collapse navbar-collapse" id="menu-site-default">
        <ul class="nav navbar-nav">
			<li class="{active_home}">
				<a class="home" title="{LANG.Home}" href="{THEME_SITE_HREF}">Home</a>
			</li>
			<!-- BEGIN: top_menu -->
            <li {TOP_MENU.current} rol="presentation">
                ...
                <!-- END: icon -->
                <a class="dropdown-toggle" {TOP_MENU.dropdown_data_toggle} href="{TOP_MENU.link}" role="button" aria-expanded="false" title="{TOP_MENU.note}" {TOP_MENU.target}>{TOP_MENU.title_trim}</a>
				<!-- BEGIN: sub -->
					{SUB}
                <!-- END: sub -->
