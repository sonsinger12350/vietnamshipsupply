...
{
	global $global_array_cat, $module_name, $module_file, $module_upload, $lang_module, $module_config, $module_info,$module_data,$db, $global_array_cat, $catid, $page ,$catid;
	...
	$xtpl->assign( 'IMGWIDTH1', $module_config[$module_name]['homewidth'] );
		...
		$sql = "SELECT title, descriptionhtml FROM " . NV_PREFIXLANG . "_" . $module_data . "_cat where catid = ". $catid ." ORDER BY sort ASC";
		$result = $db->query($sql);
		$noidung = $result->fetch();
		$xtpl->assign( 'CONTENT', $noidung);
...
function detail_theme( $news_contents, $array_keyword, $related_new_array, $related_array, $topic_array, $content_comment )
{
	...
	global $global_config, $module_info, $lang_module, $module_name, $module_file, $module_config, $lang_global, $user_info, $admin_info, $client_info, $module_upload;
