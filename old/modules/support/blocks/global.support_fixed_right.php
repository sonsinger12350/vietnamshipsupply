...
if ( ! nv_function_exists( 'nv_global_support_fixed_right' ) )
	{

	 function nv_global_support_fixed_right ()
	 {
		 global $global_config, $db;

		 if ( file_exists( NV_ROOTDIR . "/themes/" . $global_config['site_theme'] . "/modules/support/global_support_fixed_right.tpl" ) )
		 {
		 ...
		 $xtpl = new XTemplate( "global_support_fixed_right.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/modules/support" );
...
{
 $content = nv_global_support_fixed_right();
}
?>