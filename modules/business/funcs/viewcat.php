...
if (empty($contents)) {
    ...
    if ($viewcat == 'viewcat_detail_cat') {
        
        $contents = viewcat_detail_cat($global_array_cat[$catid]);
    } 
    elseif ($viewcat == 'viewcat_page_new' or $viewcat == 'viewcat_page_old' or $set_view_page) {
