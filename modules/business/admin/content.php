    ...
    if (empty($error)) {
        ...
        if ($rowcontent['id'] == 0 or $copy) {
            ...
            $sql = 'INSERT INTO ' . NV_PREFIXLANG . '_' . $module_data . '_rows (
                ...
                homeimgfile, homeimgalt, homeimgthumb, otherimage, inhome, allowed_comm, allowed_rating, external_link, hitstotal, hitscm, total_rating, click_rating, instant_active, instant_template,
                instant_creatauto
            ) VALUES (
