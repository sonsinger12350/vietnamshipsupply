...
if ($nv_Request->isset_request('submit', 'post')) {
    ...
    $array_config['table_freecontent'] = $nv_Request->get_title('table_freecontent', 'post', '');
    $array_config['table_slider'] = $nv_Request->get_title('table_slider', 'post', '');
...
$array_config['table_freecontent'] = '';
$array_config['table_slider'] = '';
...
foreach ($site_mods as $free_mod) {
    if($free_mod['module_file'] == 'freecontent'){
        $free_mod['checked'] = ($array_config['table_freecontent'] == $free_mod['module_upload']) ? 'selected="selected"' : '';
        $xtpl->assign('MODULDE_FREE', $free_mod);
        $xtpl->parse('main.freecontent');
    }
    if($free_mod['module_file'] == 'slider'){
        $free_mod['checked'] = ($array_config['table_slider'] == $free_mod['module_upload']) ? 'selected="selected"' : '';
        $xtpl->assign('MODULDE_SLIDER', $free_mod);
