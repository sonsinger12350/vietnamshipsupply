 ...
 * @return
 */
function contact_form_theme($array_content, $catsName, $base_url, $checkss, $type = 1)
{
    ...
    $xtpl = new XTemplate('form'.$type.'.tpl', NV_ROOTDIR . '/themes/' . $module_info['template'] . '/modules/' . $module_info['module_theme']);
    $xtpl->assign('CONTENT', $array_content);
    $xtpl->assign('LANG', $lang_module);
    $xtpl->assign('GLANG', $lang_global);
