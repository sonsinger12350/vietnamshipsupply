...
if ($module_name != $block_config['module'] and defined('NV_SYSTEM')) {
    if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/contact/block.contact_form_wo_btn.tpl')) {
        $block_theme = $global_config['module_theme'];
    } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/contact/block.contact_form_wo_btn.tpl')) {
    ...
    $xtpl = new XTemplate('block.contact_form_wo_btn.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/contact');
