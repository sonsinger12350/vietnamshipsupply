...
// LẤY QUẬN HUYỆN RA
$array_district = $location->getArrayDistrict($inArrayId = array(),array($row['provinceid']));
...
$array_province = $location->getArrayProvince($inArrayId = array(),array($row['countryid']));
