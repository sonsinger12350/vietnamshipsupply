...
$sql_create_module[] = "DELETE FROM ". NV_CRONJOBS_GLOBALTABLE . " WHERE run_func LIKE 'cron_newsnotice_send_mail' OR run_func LIKE 'cron_newsnotice_start_send_mail'";
$sql_create_module[] = "INSERT INTO " . NV_CRONJOBS_GLOBALTABLE . " ( id, start_time, inter_val, run_file, run_func, params, del, is_sys, act, last_time, last_result " . $list_field . " ) VALUES ( NULL, " . NV_CURRENTTIME . ", " . $interval . ", 'nv_newsnotice_auto_sendmail.php', 'cron_newsnotice_send_mail', '".$module_data.", " . $lang . "_news_rows, ".$module_name."', 0, 0, 1, " . NV_CURRENTTIME . ", 1 " . $list_value_send_stack . " )";
$sql_create_module[] = "INSERT INTO " . NV_CRONJOBS_GLOBALTABLE . " ( id, start_time, inter_val, run_file, run_func, params, del, is_sys, act, last_time, last_result " . $list_field . " ) VALUES ( NULL, " . NV_CURRENTTIME . ", " . $interval_sendmail . ", 'nv_newsnotice_auto_sendmail.php', 'cron_newsnotice_start_send_mail', '".$module_data.", " . $lang . "_news_rows, ".$module_name."', 0, 0, 1, " . NV_CURRENTTIME . ", 1 " . $list_value_send_mail . " )";