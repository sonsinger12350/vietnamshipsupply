...
if (!nv_function_exists('nv_news_block_news_new')) {
    ...
    {
        global $module_array_cat, $site_mods, $db_slave, $module_config, $lang_global, $global_config, $nv_Cache;
		...
		if(!defined('NV_IS_MODADMIN')){
			$cache_file = NV_LANG_DATA . '_block_news_new_' . $block_config['bid'] . '_' . NV_CACHE_PREFIX . '.cache';
		}
        ...
        if (($cache = $nv_Cache->getItem($module, $cache_file)) != false) {
			...
			foreach ($array_block_news as $array_news) {
				...
				$dmy = nv_date('d/m/Y', $array_news['publtime']);
				$xtpl->assign('dmy', $dmy);
