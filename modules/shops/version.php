...
$module_version = array(
    ...
    'modfuncs' => 'main,hotdeal,viewcat,detail,search,cart,order,payment,complete,history,group,search_result,compare,wishlist,tag,point,shippingajax,download, blockcat,ajax,checkout, payment_success,active_pay',
    ...
    'author' => 'Web24 <info@web24.vn>', // Tac gia
    'note' => '', // Ghi chu
    'uploads_dir' => array(
        $module_upload,
