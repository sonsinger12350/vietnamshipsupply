...
if (!function_exists('nv_pro_catalogs_img')) {

    /**
     * nv_block_config_product_catalogs_img_blocks()
     *
     * @param mixed $module
     ...
     * @return
     */
    function nv_block_config_product_catalogs_img_blocks($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_product_catalogs_img_blocks_submit()
     *
     * @param mixed $module
     * @param mixed $lang_block
     * @return
     */
    function nv_block_config_product_catalogs_img_blocks_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
     ...
     * @return
     */
    function nv_pro_catalogs_img($block_config)
    {
        ...
        $block_tpl_name = "block.catalogs_img.tpl";
            ...
            if ($cat['parentid'] == 0) {
                if ($cat['inhome'] == '1') {
                    ...
                    if (!empty($cat['subcatid'])) {
                        $sub_cat = html_viewsub($cat['subcatid'], $block_config);
                    }
...
if (defined('NV_SYSTEM')) {
    $content = nv_pro_catalogs_img($block_config);
}
