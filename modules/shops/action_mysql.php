...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_orders (
 ...
 tinhthanh int(11) NULL default '0',
 quanhuyen int(11) NULL default '0',
 xaphuong int(11) NULL default '0',
 httt varchar(255) NULL default '',
 ...
 point_using int(11) NULL default '0',
 point_money varchar(255) NULL default '0',
