...
if (!nv_function_exists('nv_block_freecontent_ports')) {
    /**
     * nv_block_config_freecontent_ports()
     *
     * @param mixed $module
     ...
     * @return
     */
    function nv_block_config_freecontent_ports($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_freecontent_ports_submit()
     *
     * @param mixed $module
     * @param mixed $lang_block
     * @return
     */
    function nv_block_config_freecontent_ports_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    /**
     * nv_block_freecontent_ports()
     *
     * @return
     */
    function nv_block_freecontent_ports($block_config)
    {
        ...
        if (!empty($list)) {
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $site_mods[$module]['module_file'] . '/block.free_content_ports.tpl')) {
                $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/' . $site_mods[$module]['module_file'] . '/block.free_content_ports.tpl')) {
                $block_theme = $global_config['site_theme'];
            } else {
                $block_theme = 'default';
            }

            $xtpl = new XTemplate('block.free_content_ports.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $site_mods[$module]['module_file']);
            $xtpl->assign('BLOCK_CFG', $block_config);
            //shuffle($list);
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_freecontent_ports($block_config);
}
