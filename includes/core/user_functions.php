...
function nv_blocks_content($sitecontent)
{
    ...
    if (($cache = $nv_Cache->getItem('themes', $cache_file)) !== false) {
        ...
        while ($_row = $_result->fetch()) {
            ...
            $block_config['link'] = $_row['link'];
            $block_config['subtitle'] = $_row['subtitle'];
            ...
            if ($_active and in_array($_row['position'], $array_position) and nv_user_in_groups($_row['groups_view'])) {
                ...
                if (!empty($content) or defined('NV_IS_DRAG_BLOCK')) {
                    ...
                    if (!empty($xtpl)) {
                        ...
                        $xtpl->assign('BLOCK_SUBTITLE', $_row['subtitle']);
						if(!empty($_row['link'])){
							$xtpl->assign('BLOCK_LINK', $_row['link']);
							$xtpl->parse('mainblock.link');
						}
                    ...
                    if (defined('NV_IS_DRAG_BLOCK')) {
                        ...
                        $act_icon = $_row['act'] ? 'icofont-checked' : 'icofont-square';
                        $content = '<div class="portlet" id="bl_' . ($_row['bid']) . '">
                             <div class="tool">
                                 <a href="javascript:void(0)" class="block_content" name="' . $_row['bid'] . '" alt="' . $lang_global['edit_block'] . '" title="' . $lang_global['edit_block'] . '"><em class="icofont-wrench"></em></a>
                                 <a href="javascript:void(0)" class="delblock" name="' . $_row['bid'] . '" alt="' . $lang_global['delete_block'] . '" title="' . $lang_global['delete_block'] . '"><em class="icofont-trash"></em></a>
                                 <a href="javascript:void(0)" class="actblock" name="' . $_row['bid'] . '" alt="' . $act_title . '" title="' . $act_title . '" data-act="' . $lang_global['act_block'] . '" data-deact="' . $lang_global['deact_block'] . '"><em class="' . $act_icon . '" data-act="icofont-checked" data-deact="icofont-square"></em></a>
                                 <a href="javascript:void(0)" class="outgroupblock" name="' . $_row['bid'] . '" alt="' . $lang_global['outgroup_block'] . '" title="' . $lang_global['outgroup_block'] . '"><em class="icofont-share-alt"></em></a>
                             </div>
    ...
    if (defined('NV_IS_DRAG_BLOCK')) {
        ...
        foreach ($array_keys as $__pos) {
            ...
            $_posReal[$__pos] .= '<a href="javascript:void(0);" class="add block_content" id="' . $__pos . '" title="' . $lang_global['add_block'] . ' ' . $__pos_name . '" alt="' . $lang_global['add_block'] . '"><em class="fa icofont-plus"></em></a>';
            $_posReal[$__pos] .= '</div>';
        }
    }
