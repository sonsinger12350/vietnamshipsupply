...
<html>
	<head>
		...
		<link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/css/googleseo.css">
		<script type="text/javascript" src="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/js/googleseo.js"></script>
		<!-- BEGIN: css_module -->
