...
function nv_add_otherimage() {
	var newitem = '';
	newitem += "<div class=\" form-group\" style='clear:both; margin-top:5px; margin-bottom:5px'>";

	newitem += "	<input class=\"w300 form-control pull-left\" type=\"text\" name=\"otherimage[]\" id=\"otherimage_" + file_items + "\" style=' margin-right:5px;'/>";
