        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="content-subdes" class="col-sm-5 control-label">Mô tả phụ</label>
                        <div class="col-sm-19">
                            <input type="text" class="form-control txt ip" id="content-subdes" name="subdes">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="content-icon" class="col-sm-5 control-label">Font icon</label>
                        <div class="col-sm-19">
                            <input type="text" class="form-control txt ip" id="content-icon" name="icon">
                        </div>
                    </div>
                    <div class="form-group">
