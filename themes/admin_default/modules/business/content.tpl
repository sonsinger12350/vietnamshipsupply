			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" style="width:calc(100% - 120px);margin-right: 5px;" type="text" name="homeimg" id="homeimg" value="{rowcontent.homeimgfile}"/><input id="select-img-post" type="button" value="{GLANG.browse_image}" name="selectimg" class="btn btn-info pull-right" /></td>
					</tr>
					<tr>
						<td><strong>{LANG.content_homeimgalt}</strong></td>
						<td><input class="form-control" type="text" maxlength="255" value="{rowcontent.homeimgalt}" id="homeimgalt" name="homeimgalt" style="width:100%;margin-right: 5px;" /></td>
					</tr>
					<tr>
					...
					<tr class="">
						<td class="text-right">{LANG.list_image}</td>
						<td>
							<div id="otherimage">
								<!-- BEGIN: otherimage -->
								<div class="form-group" style='clear:both; width:100%; margin-top:5px; margin-bottom:5px'>
									<input value="{DATAOTHERIMAGE.value}" name="otherimage[]" id="otherimage_{DATAOTHERIMAGE.id}" class="form-control w300 pull-left" maxlength="255" style='margin-right:5px'>

									<button class="btn btn-info" type="button" onclick="nv_open_browse( '{NV_BASE_ADMINURL}index.php?{NV_NAME_VARIABLE}=upload&popup=1&area=otherimage_2_{DATAOTHERIMAGE.id}&path={NV_UPLOADS_DIR}/{MODULE_UPLOAD}{module_name}&currentpath={CURRENT}&type=file', 'NVImg', 850, 500, 'resizable=no,scrollbars=no,toolbar=no,location=no,status=no' ); return false; ">
										<em class="fa fa-folder-open-o fa-fix"> Browse server</em>
									</button>
								</div>
								<!-- END: otherimage -->
							</div>
							<input type="button" class="btn btn-info" onclick="nv_add_otherimage();" value="{LANG.add_other_image}">
						</td>
					</tr>
					<tr>
					...
					<tr>
                        ...
                        <br>
						<div style="margin:0; display:block; position:relative">
							{edit_bodytext}
						</div>
                        </td>
					</tr>
					...
					<tr>
						<td>{LANG.content_description}:</td>
						<td>
						<textarea id="description" name="description" class="form-control" rows="5" style="width: 100%">{rowcontent.description}</textarea>
			...
			<ul style="padding-left:0px; margin:0">
				...
				<li>
					<p class="message_head">
						...
						<span class="timestamp">{LANG.content_notetime}</span>
					</p>
					<div class="message_body">
