		...
		<div class="col-sm-24 col-md-18">
					...
					<div class="row">
						...
						<div class="form-group">
							<div class="col-md-8 col-md-push-4">
								<label><input type="checkbox" name="showprice" value="1" {ck_showprice}/>{LANG.content_showprice}</label>
							</div>
						</div>
						
						<div class="hidden content_setting_price col-md-push-4 col-md-20">
						
							<div class="setting_price">
								<input type="button" class="btn btn-info" onclick="nv_add_setting();" value="{LANG.setting_price}">
							</div>
							<div class="result_price">
								<!-- BEGIN: price_s -->
								<div class="form-control_setting">
									<input placeholder="{LANG.title_setting}" type="text" value="{price_s.title}" name="title_setting[]"/>
									<input value="{price_s.price}" placeholder="{LANG.price_setting}" type="text" name="price_setting[]"/>
								</div>
								<!-- END: price_s -->
							</div>
							
							<script>
								function nv_add_setting()
								{
									var html = '<div class="form-control_setting"><input placeholder="{LANG.title_setting}" type="text" name="title_setting[]"/><input placeholder="{LANG.price_setting}" type="text" name="price_setting[]"/></div>';
									
									$('.result_price').append(html);
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						<div class="">
							<input class="form-control pull-left" type="text" name="homeimg" id="homeimg" value="{rowcontent.homeimgfile}" style="width: calc(100% - 114px);margin-right: 5px;"/>
							<button class="btn btn-default btn-info" type="button" id="selectimg">
								{LANG.file_selectfile}
							</button>
							<span class="input-group-btn">
							</span>
		...
		<div class="col-sm-24 col-md-6">
					...
					<div class="" style="overflow: auto">
						<div class="clearfix uiTokenizer uiInlineTokenizer">
							<div id="keywords" class="tokenarea">
								<!-- BEGIN: keywords_text -->
								<span class="uiToken removable" title="{KEYWORDS}" ondblclick="$(this).remove();"> {KEYWORDS_TEXT} <input type="hidden" autocomplete="off" name="keywords[]" value="{KEYWORDS_TEXT}" /> <a onclick="$(this).parent().remove();" class="remove uiCloseButton uiCloseButtonSmall" href="javascript:void(0);"></a> </span>
								<!-- END: keywords_text -->
							</div>
			...
			<div class="panel panel-default hidden">
				...
				<div class="panel-body">
					...
					<div class="hidden" style="margin-bottom: 2px;">
