	...
	<div class="table-responsive">
		<table id="edit" class="table table-striped table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					<td class="text-right"><strong>{LANG.name} Seo: </strong></td>
					<td><input class="form-control w500" name="titlesite" type="text" value="{titlesite}" maxlength="255" /></td>
				</tr>
				...
				<tr>
					<td class="text-right"><strong>{LANG.ratename}: </strong></td>
					<td><input class="form-control w500" name="ratename" type="text" value="{ratename}" maxlength="255" /></td>
				</tr>
				<tr>
					<td class="text-right"><strong>{LANG.ratenumber}: </strong></td>
					<td><input class="form-control w500" name="ratenumber" type="text" value="{ratenumber}" maxlength="255" /></td>
				</tr>
				<tr>
					<td class="text-right"><strong>{LANG.name} người đọc: </strong></td>
