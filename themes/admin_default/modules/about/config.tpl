		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr>
						<td>{LANG.setting_rate}</td>
						<td><input type="checkbox" value="1" name="rate_page"{RATE_PAGE}/></td>
					</tr>
					...
					<tr>
						<td>Table freecontent</td>
						<td>
							<select class="form-control" name="table_freecontent">
								<option>Không chọn</option>
								<!-- BEGIN: freecontent -->
								<option value="{MODULDE_FREE.module_data}" {MODULDE_FREE.checked}>{MODULDE_FREE.admin_title}</option>
								<!-- END: freecontent -->
							</select>
						</td>
					</tr>
					<tr>
						<td>Table slider</td>
						<td>
							<select class="form-control" name="table_slider">
								<option>Không chọn</option>
								<!-- BEGIN: slider -->
								<option value="{MODULDE_SLIDER.module_data}" {MODULDE_SLIDER.checked}>{MODULDE_SLIDER.admin_title}</option>
								<!-- END: slider -->
							</select>
						</td>
					</tr>
