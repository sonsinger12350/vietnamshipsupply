    ...
    <div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="" method="post"  enctype="multipart/form-data" id="form-photo" class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label" for="input-description2">{LANG.photo_description} 2</label>
					<div class="col-sm-20">
						 <textarea name="description2" rows="5" col="3" id="input-description2" placeholder="{LANG.photo_description} 2" class="form-control">{DATA.description2}</textarea>						 
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label" for="input-description3">{LANG.photo_description} 3</label>
					<div class="col-sm-20">
						 <textarea name="description3" rows="5" col="3" id="input-description3" placeholder="{LANG.photo_description} 3" class="form-control">{DATA.description3}</textarea>						 
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label" for="input-description4">{LANG.photo_description} 4</label>
					<div class="col-sm-20">
						 <textarea name="description4" rows="5" col="3" id="input-description4" placeholder="{LANG.photo_description} 4" class="form-control">{DATA.description4}</textarea>						 
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label" for="input-description5">{LANG.photo_description} 5</label>
					<div class="col-sm-20">
						 <textarea name="description5" rows="5" col="3" id="input-description5" placeholder="{LANG.photo_description} 5" class="form-control">{DATA.description5}</textarea>						 
					</div>
				</div>
				<div class="form-group">
