...
<div class="wraper">
    ...
    <!-- END: bbodytext -->
    <div class="full-request_quote wraper">
        [PARTNER]
    </div>
    <div class="row">
        ...
        <div class="col-sm-24 col-md-24">
            <div class="block_contact template_default">
...
<div class="wraper">
    <div class="row mg15">
        <div class="col-xs-12 col-md-8">[CONTACT_INFO1]</div>
        <div class="col-xs-12 col-md-8">[CONTACT_INFO2]</div>
        <div class="col-xs-12 col-md-8">[CONTACT_INFO3]</div>
        <div class="col-xs-12 col-md-8">[CONTACT_INFO4]</div>
        <div class="col-xs-12 col-md-8">[CONTACT_INFO5]</div>
        <div class="col-xs-12 col-md-8">[CONTACT_INFO6]</div>
        <div class="col-xs-12 col-md-8">[CONTACT_INFO7]</div>
        <div class="col-xs-12 col-md-8">[CONTACT_INFO8]</div>
        <div class="col-xs-12 col-md-8">[CONTACT_INFO9]</div>
    </div>
</div>
<!-- END: main -->