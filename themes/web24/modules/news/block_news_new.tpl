...
<div class="news_new-list row mg15">
	<!-- BEGIN: other -->
	<div class="col-xs-12 col-sm-8 news_new-item hover_scale_img">
...
<div class="text-center">
	<a class="btn_cus -bg_primary -white -brd_primary" href="{LINK_MODULE}" title="{GLANG.seemore}">{GLANG.readmore}</a>
</div>
<!-- END: main -->