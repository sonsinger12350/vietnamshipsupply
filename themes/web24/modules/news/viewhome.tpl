...
<h2><i class="fa fa-bars"></i><a title="{CAT.title}" href="{CAT.link}">{CAT.title}right</a></h2>
...
<div class="tms_cat clearfix">	
<div class="tms_cat_title products-1">
<h2><i class="fa fa-bars"></i><a title="{CAT.title}" href="{CAT.link}">{CAT.title}left</a></h2>
<div class="tms_cat_right">
<ul class="list-inline sub-list-icon" style="margin: 0">
