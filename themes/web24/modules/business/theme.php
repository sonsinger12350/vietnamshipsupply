...
{
    global $site_mods, $module_name, $module_upload, $lang_module, $lang_global, $module_config, $module_info, $global_array_cat, $global_array_cat, $catid, $page;
...
{
    global $global_config, $module_info, $lang_module, $lang_global, $module_name, $module_upload, $module_config, $lang_global, $client_info;
    ...
    if( !empty( $news_contents['otherimage'] ) )
    {
        $otherimage = explode( '|', $news_contents['otherimage'] );
 ...
 * @return
 */
function viewcat_detail_cat($news_contents)
{
    global $global_config, $module_info, $lang_module, $module_name, $module_upload, $module_config, $lang_global, $client_info;

    $xtpl = new XTemplate('viewcat_detail.tpl', NV_ROOTDIR . '/themes/' . $module_info['template'] . '/modules/' . $module_info['module_theme']);
    $xtpl->assign('GLANG', $lang_global);
    $xtpl->assign('NV_BASE_SITEURL', NV_BASE_SITEURL);
    $xtpl->assign('TEMPLATE', $global_config['module_theme']);
    $xtpl->assign('LANG', $lang_module);
