...
$(function() {
    ...
    if (a) {
        ...
        b.on("click", function() {
			...
			return ($.ajax({
				...
				data: "loadForm=2&checkss=" + e.data("cs"),
				dataType: "html",
				success: function(a) {
					e.html(a);
    ...
    var a = $("#form_home");
    if (a) {
        var contact_home = $(".contact_home", a),
            e2 = $("[data-cs]", a);
        ($.ajax({
                type: "POST",
                cache: !1,
                url: nv_base_siteurl + "index.php?" + nv_lang_variable + "=" + nv_lang_data + "&" + nv_name_variable + "=" + contact_home.attr( "data-module" ),
                data: "loadForm=2&checkss=" + e2.data("cs"),
                dataType: "html",
                success: function(a) {
                    e2.html(a);
					if (typeof nv_is_recaptcha != "undefined" && nv_is_recaptcha && nv_recaptcha_elements.length > 0) {
