...
<div class="col-md-12 col-md-push-6">
	...
	<form  name="NLpayBank" action="#" method="post">	
		<table class="table table-striped table-bordered table-hover" style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr>
				<td>Mã đơn hàng:</td>
				<td><label>{tt.order_code}</label></td>
			</tr>
			<tr><td>Số tiền thanh toán: </td>
				<td>
					<label>{tt.tien_thanhtoan_fomat} vnđ</label>
					 <input type="hidden" value="{tt.tien_thanhtoan}" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="">
					 <input type="hidden" value="{tt.order_id}" style="width:270px" id="order_code" name="order_code" class="field-check " value="">
				</td>
			</tr>
			<tr><td>Họ Tên: </td>
				<td>
					 <input class="form-control" type="text" style="width:270px" id="fullname" name="buyer_fullname" class="field-check " value="{tt.order_name}">
				</td>
			</tr>
			<tr><td>Email: </td>
				<td>
					 <input class="form-control" type="text" style="width:270px" id="fullname" name="buyer_email" class="field-check " value="{tt.order_email}">
				</td>
			</tr>
			<tr><td>Số Điện thoại: </td>
				<td>
					 <input class="form-control" type="text" style="width:270px" id="fullname" name="buyer_mobile" class="field-check " value="{tt.order_phone}">
				</td>
			</tr>				
		</table>	
	...
	<table style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr><td></td>
				<td>
					 <input style="margin-bottom:20px;" type="submit" name="nlpayment" class="btn btn-info" value="thanh toán"/>
				</td>
			</tr>					
		</table>
	</form>	
