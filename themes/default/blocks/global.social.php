...
if (! nv_function_exists('nv_menu_theme_social')) {
    function nv_menu_theme_social_config($module, $data_block, $lang_block)
    {
        ...
        $html .= '  <label class="control-label col-sm-6">Messenger:</label>';
        $html .= '  <div class="col-sm-18"><input type="text" name="config_mess" class="form-control" value="' . $data_block['mess'] . '"/></div>';
        $html .= '</div>';
        $html .= '<div class="form-group">';
        $html .= '  <label class="control-label col-sm-6">Instagram:</label>';
        $html .= '  <div class="col-sm-18"><input type="text" name="config_inst" class="form-control" value="' . $data_block['inst'] . '"/></div>';
        $html .= '</div>';
